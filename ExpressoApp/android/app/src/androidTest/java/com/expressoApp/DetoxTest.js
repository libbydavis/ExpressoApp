...
public class DetoxTest {
    ...
    public ActivityTestRule<SplashActivity> sActivityRule = new ActivityTestRule<>(SplashActivity.class, false, false);
    ...
    public void runDetoxTests() {
        ...
        detoxConfig.rnContextLoadTimeoutSec = (com.expressoapp.BuildConfig.DEBUG ? 180 : 60);
